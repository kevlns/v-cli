...
npm install -g @kevlns/u-cli-mod@0.1.0
...
> `@kevlns/xlmerge@1.2.1` / `@kevlns/u-cli-mod@0.1.0` 已发布并由 `npm install`
...
| --- | --- | --- |
| [`v-cli`](https://github.com/kevlns/v-cli) | 个人工具箱 CLI（本仓库） | v0.2.0 |
| [`xlmerge`](https://github.com/kevlns/xlmerge) | Git 中 .xlsx/.xlsm 冲突可视化解决工具 | v1.2.1 |
