 ...
 * 断言：包身份 @kevlns/v-cli@0.2.0-beta.2、必需文件齐全、禁止内容（src/tests/scripts/
...
const EXPECTED_VERSION = "0.2.0-beta.2";
...
export function runPackGuard({ cwd = ROOT, keepTarball = false } = {}) {
  ...
  try {
    ...
    const expectedTarball = "kevlns-v-cli-0.2.0-beta.2.tgz";
    ...
    if (pkgOut.status !== 0) {
      ...
      const pinned = {
        "@kevlns/xlmerge": "1.2.1-beta.2",
        "@kevlns/u-cli-mod": "0.1.0-beta.2",
      };
